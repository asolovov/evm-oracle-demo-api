# Agent Guide for go-evm-oracle-demo-api
...
- Build binary output: `./github.com/asolovov/evm-oracle-demo-api` in repo root.
- Run app: `make run` (invokes `go run -race cmd/github.com/asolovov/evm-oracle-demo-api.go serve`).
- Show version template at runtime: `./github.com/asolovov/evm-oracle-demo-api --version`.
- `cmd/github.com/asolovov/evm-oracle-demo-api.go`: entry; wires cobra root + serve, executes CLI.
- Keep binary name driven by `APP` variable (`github.com/asolovov/evm-oracle-demo-api`).
...
## Imports
- Group imports: stdlib, blank line, third-party, blank line, local (`github.com/asolovov/evm-oracle-demo-api/...`).
...
- Current binary: `/github.com/asolovov/evm-oracle-demo-api` (synced with `APP:=github.com/asolovov/evm-oracle-demo-api`).
- `make rename` updates Dockerfile automatically.
- Build: `docker build -t github.com/asolovov/evm-oracle-demo-api .`
- Run: `docker run --rm github.com/asolovov/evm-oracle-demo-api` (defaults to `serve`).
